...
TCPClient.prototype = new events.EventEmitter();
...
TCPClient.prototype._registerEnd = function(client, server) {
	var self = this;
...
module.exports = {
	...
	connect : function(server) {
		...
		client.extend(require('./common.js'));
		return client;
	}
};
